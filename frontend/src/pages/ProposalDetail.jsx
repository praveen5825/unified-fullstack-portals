  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="btn btn-danger text-xs rounded-xl"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="card p-6 animate-fade-in relative overflow-hidden">
            ...
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-medium" style={{ background: 'var(--color-surface-3)', color: 'var(--color-text-primary)' }}>
              <GraduationCap size={13} style={{ color: 'var(--color-text-muted)' }} /> {proposal.research_area}
            </div>
          </div>
        ...
        {/* ─── Document Sidebar ─── */}
        <div className="card p-5 animate-slide-in-left h-fit sticky top-6">
          ...
          {proposal.document ? (
            ...
            <div className="h-64 flex flex-col items-center justify-center rounded-xl mb-4" style={{ background: 'var(--color-surface-2)', border: '1px dashed var(--color-border)' }}>
